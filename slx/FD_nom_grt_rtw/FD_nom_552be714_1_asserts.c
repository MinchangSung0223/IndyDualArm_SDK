...
void FD_nom_552be714_1_validateRuntimeParameters(const double *rtp, int32_T
  *satFlags)
{
  boolean_T bb[24];
  double xx[1];
...
const NeAssertData FD_nom_552be714_1_assertData[24] = {
  { "FD_nom/DualArm/Left/l_joint_0", 0, 0, "DualArm.Left.l_joint_0", "", false,
  ...
  { "FD_nom/DualArm/Left/l_joint_1", 0, 0, "DualArm.Left.l_joint_1", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Left/l_joint_2", 0, 0, "DualArm.Left.l_joint_2", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Left/l_joint_3", 0, 0, "DualArm.Left.l_joint_3", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Left/l_joint_4", 0, 0, "DualArm.Left.l_joint_4", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Left/l_joint_5", 0, 0, "DualArm.Left.l_joint_5", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Right/r_joint_0", 0, 0, "DualArm.Right.r_joint_0", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Right/r_joint_1", 0, 0, "DualArm.Right.r_joint_1", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Right/r_joint_2", 0, 0, "DualArm.Right.r_joint_2", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Right/r_joint_3", 0, 0, "DualArm.Right.r_joint_3", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Right/r_joint_4", 0, 0, "DualArm.Right.r_joint_4", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "FD_nom/DualArm/Right/r_joint_5", 0, 0, "DualArm.Right.r_joint_5", "", false,
    "The parameter Rz/Position contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
