...
#else
  #define CASADI_PREFIX(ID) exp6_ ## ID
#endif
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real *w0=w+199, *w1=w+205, *w2=w+221;
  /* #0: @0 = input[0][0] */
  casadi_copy(arg[0], 6, w0);
  /* #1: @1 = VecTose3(@0) */
  arg1[0]=w0;
...
#ifdef MATLAB_MEX_FILE
void mex_exp6(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  casadi_int i;
  int mem;
  casadi_real w[259];
  casadi_int *iw = 0;
  ...
  casadi_real* res[7] = {0};
  if (argc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"exp6\" failed. Too many input arguments (%d, max 1)", argc);
  if (resc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"exp6\" failed. Too many output arguments (%d, max 1)", resc);
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s0, w+22);
  --resc;
  res[0] = w+6;
  exp6_incref();
  mem = exp6_checkout();
  i = exp6(arg, res, iw, w+22, mem);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"exp6\" failed.");
  exp6_release(mem);
  exp6_decref();
...
void mexFunction(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (!buf_ok) {
    mex_exp6(resc, resv, argc, argv);
    return;
  } else if (strcmp(buf, "exp6")==0) {
    mex_exp6(resc, resv, argc-1, argv+1);
    return;
  }
  mexErrMsgTxt("First input should be a command string. Possible values: 'exp6'");
}
#endif
#ifdef __cplusplus
} /* extern "C" */
