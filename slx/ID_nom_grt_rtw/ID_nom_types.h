...
#ifndef ID_nom_types_h_
#define ID_nom_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_h_cell_wrap_ID_nom_T
#define typedef_h_cell_wrap_ID_nom_T

typedef struct tag_xcgxZ5He9ABYYFkMb0gw9F h_cell_wrap_ID_nom_T;

#endif                                 /* typedef_h_cell_wrap_ID_nom_T */
...
#ifndef typedef_b_rigidBodyJoint_ID_nom_T
#define typedef_b_rigidBodyJoint_ID_nom_T

typedef struct tag_0wAA6tLoej0zPuTCXXY0HG b_rigidBodyJoint_ID_nom_T;

#endif                                 /* typedef_b_rigidBodyJoint_ID_nom_T */
...
#ifndef typedef_g_cell_wrap_ID_nom_T
#define typedef_g_cell_wrap_ID_nom_T

typedef struct tag_xcgxZ5He9ABYYFkMb0gw9F g_cell_wrap_ID_nom_T;

#endif                                 /* typedef_g_cell_wrap_ID_nom_T */
...
struct tag_Uq7zxijFmQhcuf59duCKAE
{
  ...
  e_robotics_manip_internal_Cha_T NameInternal;
  real_T Index;
  b_rigidBodyJoint_ID_nom_T JointInternal;
  real_T ParentIndex;
...
#ifndef typedef_f_robotics_manip_internal_R_i_T
#define typedef_f_robotics_manip_internal_R_i_T

typedef struct tag_bkWCCCuV0NgMFyRNsVzifC f_robotics_manip_internal_R_i_T;

#endif                             /* typedef_f_robotics_manip_internal_R_i_T */
...
struct tag_Gghd2cQxHm3F8cWuMy0zxE
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  f_robotics_manip_internal_R_i_T TreeInternal;
};
...
typedef struct tag_Gghd2cQxHm3F8cWuMy0zxE robotics_slmanip_internal_b_i_T;
...
#ifndef typedef_robotics_slmanip_internal__iw_T
#define typedef_robotics_slmanip_internal__iw_T

typedef struct tag_mlepuvkvPcxlj5FLTOS07E robotics_slmanip_internal__iw_T;

#endif                             /* typedef_robotics_slmanip_internal__iw_T */
...
#ifndef typedef_emxArray_real_T_ID_nom_T
#define typedef_emxArray_real_T_ID_nom_T

typedef struct emxArray_real_T emxArray_real_T_ID_nom_T;

#endif                                 /* typedef_emxArray_real_T_ID_nom_T */
...
typedef struct P_ID_nom_T_ P_ID_nom_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_ID_nom_T RT_MODEL_ID_nom_T;

#endif                                 /* ID_nom_types_h_ */
