...
void FD_cd27307_1_computeRuntimeParameters(const real_T t0[], real_T out[])
{
  real_T t11[1];
  real_T t12[1];
  real_T t13[1];
  ...
  t12[0UL] = t0[10UL];
  t13[0UL] = t0[11UL];
  memcpy(&t14[0], &t9[0], 8U);
  memcpy(&t9[0], &t12[0], 8U);
  memcpy(&t12[0], &t6[0], 8U);
  memcpy(&t6[0], &t18[0], 8U);
  memcpy(&t18[0], &t5[0], 8U);
  memcpy(&t5[0], &t2[0], 8U);
  memcpy(&t2[0], &t7[0], 8U);
  memcpy(&t7[0], &t22[0], 8U);
  memcpy(&t22[0], &t4[0], 8U);
  memcpy(&t4[0], &t13[0], 8U);
  memcpy(&t13[0], &t8[0], 8U);
  memcpy(&t8[0], &t11[0], 8U);
  out[0UL] = t14[0UL];
  out[1UL] = t9[0UL];
  out[2UL] = t12[0UL];
  out[3UL] = t6[0UL];
...
void FD_cd27307_1_computeAsmRuntimeDerivedValuesDoubles(const double *rtp,
  double *rtdvd)
{
  boolean_T bb[2];
  double xx[13];
...
void FD_cd27307_1_computeAsmRuntimeDerivedValuesInts(const double *rtp, int
  *rtdvi)
{
  (void) rtp;
  (void) rtdvi;
...
void FD_cd27307_1_computeAsmRuntimeDerivedValues(const double *rtp,
  RuntimeDerivedValuesBundle *rtdv)
{
  FD_cd27307_1_computeAsmRuntimeDerivedValuesDoubles(rtp, rtdv->mDoubles.mValues);
  FD_cd27307_1_computeAsmRuntimeDerivedValuesInts(rtp, rtdv->mInts.mValues);
}

void FD_cd27307_1_computeSimRuntimeDerivedValuesDoubles(const double *rtp,
  double *rtdvd)
{
  (void) rtp;
  (void) rtdvd;
...
void FD_cd27307_1_computeSimRuntimeDerivedValuesInts(const double *rtp, int
  *rtdvi)
{
  (void) rtp;
  (void) rtdvi;
...
void FD_cd27307_1_computeSimRuntimeDerivedValues(const double *rtp,
  RuntimeDerivedValuesBundle *rtdv)
{
  FD_cd27307_1_computeSimRuntimeDerivedValuesDoubles(rtp, rtdv->mDoubles.mValues);
  FD_cd27307_1_computeSimRuntimeDerivedValuesInts(rtp, rtdv->mInts.mValues);
}
