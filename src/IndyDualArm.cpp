...
void IndyDualArm::setLambda(){
        lambda_l<<      -1.5255     ,-0.11195  ,      -0.45    , -0.23208  , -0.0072267,    -0.091103,   2.4395e-21,
                    0.71153     ,0.024691  ,-1.0334e-22    ,  0.18147  ,  -0.044711,     0.028622,  -2.1164e-16,
                    0.41241     , 0.24375  ,    -0.0305    ,  0.14137  ,    0.14507,      0.17452,         0.06,
                8.8807e-07      , 1.2092   ,         0     , -1.2092   ,    1.2092 ,     -1.2092 ,    -2.9e-16,
                    2.718       ,1.2092  ,-3.4438e-41      ,-1.2091    ,   1.2092  ,    -1.2091,  -8.1315e-20,
                    1.5754      ,-1.2091 ,           0     ,  1.2092   ,   -1.2091 ,      1.2092,            0;
        ...
        lambda_lr<<-2.43945488809241e-21 ,0.0911029490978084 ,0.00722667581655138 ,0.232084291010446 ,0.450000000000000 ,0.111945470245711 ,-0.701934663685412 ,-0.111945470245711 ,-0.450000000000000 ,-0.232084291010446 ,-0.00722667581655134 ,-0.0911029490978080 ,-2.58853268680914e-20,
        2.11636264069170e-16 ,-0.0286221059600172 ,0.0447110760186112 ,-0.181466898367025 ,1.03338019565025e-22 ,-0.0246912114191471 ,0.00107834177065615 ,0.0246912114191473 ,1.73472347597681e-18 ,0.181466898367023 ,-0.0447110760186111 ,0.0286221059600170 ,2.25514051876985e-16,
        -0.0600000000000001 ,-0.174516399919260 ,-0.145068226710239 ,-0.141365128073727 ,0.0305000000000000 ,-0.243747835971880 ,-0.000617526260269617 ,0.243747835971880 ,-0.0305000000000000 ,0.141365128073727 ,0.145068226710239 ,0.174516399919260 ,0.0600000000000000,
        2.89997910742606e-16 ,1.20917417943659 ,-1.20917417943659 ,1.20917417943659 ,0 ,-1.20917417943659 ,8.63118783401736e-10 ,1.20917417943659 ,-1.04335921901920e-16 ,-1.20917417943659 ,1.20917417943659 ,-1.20917417943659 ,1.83339582048191e-16,
        8.13151629364129e-20 ,1.20905770917293 ,-1.20917417943659 ,1.20905770917293 ,3.44383110592467e-41 ,-1.20917417943659 ,-2.72601580298935 ,1.20917417943659 ,5.59082217244013e-17 ,-1.20905770917293 ,1.20917417943659 ,-1.20905770917293 ,4.06575814682064e-20,
        0 ,-1.20917417943659 ,1.20905770917293 ,-1.20917417943659 ,0 ,1.20905770917293 ,1.56154991476941 ,-1.20905770917293 ,-1.31751732895636e-17 ,1.20917417943659 ,-1.20905770917293 ,1.20917417943659 ,0;
}
/* ───────── Life-cycle ───────── */
                                  ...
                                  const Eigen::VectorXd &qdot_lr)
{
    ...
    this->r.M = this->lr.M.block<6,6>(0,0);
    this->l.M = this->lr.M.block<6,6>(6,6);
    this->r.c = this->lr.c.segment(0,6);
    this->l.c = this->lr.c.segment(0,6);
    this->r.g = this->lr.g.segment(6,6);
    this->l.g = this->lr.g.segment(6,6);
