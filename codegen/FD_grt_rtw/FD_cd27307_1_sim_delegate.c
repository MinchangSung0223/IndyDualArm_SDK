...
void FD_cd27307_1_resetSimStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void FD_cd27307_1_perturbSimJointPrimitiveState(const void *mech, size_t
...
void FD_cd27307_1_perturbFlexibleBodyState(const void *mech, size_t stageIdx,
...
void FD_cd27307_1_constructStateVector(const void *mech, const double
...
void FD_cd27307_1_extractSolverStateVector(const void *mech, const double
...
void FD_cd27307_1_extractDiscreteStateVector(const void *mech, const double
...
boolean_T FD_cd27307_1_isPositionViolation(const void *mech, const
...
boolean_T FD_cd27307_1_isVelocityViolation(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId FD_cd27307_1_projectStateSim(const void *mech, const
...
void FD_cd27307_1_computeConstraintError(const void *mech, const
...
boolean_T FD_cd27307_1_hasJointUpwardModeChange(const void *mech, const int
...
PmfMessageId FD_cd27307_1_performJointUpwardModeChange(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const int
...
void FD_cd27307_1_onModeChangedCutJoints(const void *mech, const int
...
void FD_cd27307_1_setVariableModeJointsToLocked(const void *mech, int
  *modeVector)
{
  (void) mech;
  (void) modeVector;
