...
const NeZCData *FD_552be714_1_ZCData = NULL;
PmfMessageId FD_552be714_1_computeAsmModeVector(const double *input, const
...
PmfMessageId FD_552be714_1_computeSimModeVector(const double *input, const
  double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId FD_552be714_1_computeZeroCrossings(const RuntimeDerivedValuesBundle
