...
void FD_nom_552be714_1_computeRuntimeParameters(const real_T t0[], real_T out[])
{
  real_T t11[1];
  real_T t12[1];
  real_T t13[1];
...
void FD_nom_552be714_1_computeAsmRuntimeDerivedValuesDoubles(const double *rtp,
  double *rtdvd)
{
  boolean_T bb[2];
  double xx[13];
...
void FD_nom_552be714_1_computeAsmRuntimeDerivedValuesInts(const double *rtp, int
  *rtdvi)
{
  (void) rtp;
  (void) rtdvi;
...
void FD_nom_552be714_1_computeAsmRuntimeDerivedValues(const double *rtp,
  RuntimeDerivedValuesBundle *rtdv)
{
  FD_nom_552be714_1_computeAsmRuntimeDerivedValuesDoubles(rtp,
    rtdv->mDoubles.mValues);
  FD_nom_552be714_1_computeAsmRuntimeDerivedValuesInts(rtp, rtdv->mInts.mValues);
}

void FD_nom_552be714_1_computeSimRuntimeDerivedValuesDoubles(const double *rtp,
  double *rtdvd)
{
  (void) rtp;
  (void) rtdvd;
...
void FD_nom_552be714_1_computeSimRuntimeDerivedValuesInts(const double *rtp, int
  *rtdvi)
{
  (void) rtp;
  (void) rtdvi;
...
void FD_nom_552be714_1_computeSimRuntimeDerivedValues(const double *rtp,
  RuntimeDerivedValuesBundle *rtdv)
{
  FD_nom_552be714_1_computeSimRuntimeDerivedValuesDoubles(rtp,
    rtdv->mDoubles.mValues);
  FD_nom_552be714_1_computeSimRuntimeDerivedValuesInts(rtp, rtdv->mInts.mValues);
}
